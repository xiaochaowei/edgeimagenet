...
class BlurZipNet_L(nn.Module):
    ...
    def forward(self, x):
        ...
        # out = self.BF(self.tanh(self.conv3(out)))
        out = bilu(self.tanh(self.conv4(out)))
        return out


class BlurZipNet_L2(nn.Module):
    def __init__(self):
        super(BlurZipNet_L2, self).__init__()
        self.std = 8/255 * 2
        # filter_weight = torch.Tensor([[0.00048091, 0.00501119, 0.01094545, 0.00501119, 0.00048091],
        #                              [0.00501119, 0.0522178,  0.11405416, 0.0522178,  0.00501119],
        #                              [0.01094545, 0.11405416, 0.2491172,  0.11405416, 0.01094545],
        ...
        self.conv5 = nn.Conv2d(128, 1, kernel_size=3, stride=1,
                               padding=1, bias=False)
        self.tanh = nn.Tanh()
        # self.BF = BinarizedF()
    ...
    def forward(self, x):
        ...
        out = bilu(self.tanh(self.conv5(out)))
        return out
